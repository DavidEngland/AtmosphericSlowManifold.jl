\begin{tikzpicture}[
    ...
    \draw[axis] (-0.5,-1,0) -- (9.5,-1,0) node[right, font=\small\sffamily] {Slow Variable $a_1(t)$};
    \draw[axis] (-0.5,-1,0) -- (-0.5,4.5,0) node[above, font=\small\sffamily] {Fast Subspace $\mathbf{a}_{\text{fast}}$};
